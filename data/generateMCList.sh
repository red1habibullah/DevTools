betterDAS.py dataset --primaryDatasets\
 ...
 "TGJets_Tune*pythia8" "TTGG*" "TTGJets*"\
 "W*JetsToLNu_Tune*" "WJetsToLNu_Tune*" "WJetsToLNu_Pt-*"\
 "WGG*" "WWG*" "WWW*" "WWZ*" "WZG*" "WZZ*" "ZZZ*" "ZGGTo*amcatnlo*"\
 "WWTo2L2Nu_13TeV-powheg" "WWToLNuQQ_13TeV-powheg" "WWTo4Q_13TeV-powheg"\
 "WZTo3LNu_Tune*" "WZToLNu2Q_13TeV*" "WZTo2Q2Nu_13TeV*" "WZTo2L2Q_13TeV*" "WZTo1L3Nu_13TeV*" "WZTo1L1Nu2Q_13TeV*" "WZTo3LNu_13TeV*"\
 "ZGTo2LG_Tune*" "WGToLNuG_Tune*"\
 "GluGluToContinToZZ*" "ZZTo4Q_13TeV*" "ZZTo4L_13TeV*" "ZZTo2L2Nu_13TeV*" "ZZTo2L2Q_13TeV*" "ZZTo2Q2Nu_13TeV*"\
