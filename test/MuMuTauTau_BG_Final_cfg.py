...
options.outputFile = 'mumutautau_BG_Final.root'
...
options.maxEvents =-1
options.register('skipEvents',100, VarParsing.multiplicity.singleton, VarParsing.varType.int, "Events to skip")
...
addMuMuTauTau(process,options,doMM=True)

dump_file = open('dump_config_BG.py','w')
